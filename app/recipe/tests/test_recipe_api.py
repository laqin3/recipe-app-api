...
class PrivateRecipeAPITest(TestCase):
    ...
    def test_create_recipe_with_new_tags(self):
        ...
        self.assertEqual(res.status_code, status.HTTP_201_CREATED)
        recipes = Recipe.objects.filter(user=self.user)
        self.assertEqual(recipes.count(), 1)  # checking count, then index
        recipe = recipes[0]
    ...
    def test_update_recipe_assign_ingredient(self):
        """Test assinging an existing ingredient when udpating a recipe."""
    ...
    def test_filter_by_tags(self):  # 131
    ...
    def test_filter_by_ingredients(self):
        """Filtering tests by ingredients."""
        ...
        r3 = create_recipe(user=self.user, title='Red Lenti Dahl')
